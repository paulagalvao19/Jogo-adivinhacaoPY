...
def escolha():
    ...
    while tentativas < 10:
        try:
            ...
            print('Por favor, insira um número válido!')  # Mensagem amigável para entrada inválida


    if tentativas == 10 and numero_secreto != numEscolhido:
        print(f'Você perdeu! O número secreto era {numero_secreto}. Tente novamente!')
